<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Theme="Default" StylesheetTheme="Default" CodeFile="Gap_Request.aspx.cs" Inherits="GapRequest " MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        ...
                        <span><strong> Year/ Semester Gap Request</strong></span>
                    </div>
                    <div class="box-icons">
  ...
  <div  runat="server" style="padding:30px ; " >
   ...
   <div class="row">
    ...
    <div class="row">
        ...
        <section class="col col-lg-10" style="height:50px">           
           <asp:TextBox ID="txtReason" runat="server" CssClass="form-control" ValidationGroup="NewCompany" Width="50%" MaxLength="250"></asp:TextBox>
      ...
      <div class="row" runat="server">
            <section class="col col-lg-12">
                  <asp:Button runat="server" CssClass="btn btn-primary" Style="margin-left: 5px;" ValidationGroup="NewCompany" ID="btnSubmit" Text="Submit"  OnClick="btnSubmit_Click1" UseSubmitBehavior="false" Visible="true"></asp:Button>
            </section>
            </div>
      </div>
    <script>
