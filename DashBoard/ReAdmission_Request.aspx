<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Theme="Default" 
    ...
    CodeFile="ReAdmission_Request.aspx.cs" 
    Inherits="ReAdmission_Request "
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server" Visible="true">
            ...
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        ...
                        <span><strong>Re-Admission for No- Show More Than 2 SEM</strong></span>
                    </div>
                    <div class="box-icons">
  ...
  <div  runat="server" style="padding:30px ; " >
   ...
   <div class="row">
    ...
    <div class="row">
         <section class="col col-lg-2" style="height:50px">
              <label>Student's Petition </label>
          </section>
        <section class="col col-lg-10" style="height:50px">           
